---
type: concept
tags: [gtm, marketing-skill, directory-submissions]
created: 2026-09-14
updated: 2026-09-14
status: stable
...
When the user wants to submit their product to startup, SaaS, AI, agent, MCP, no-code, or review directories for backlinks, domain rating, and discovery. Also use when the user mentions "directory...
...
- [raw/_marketingskills/skills/directory-submissions/SKILL.md](../../raw/_marketingskills/skills/directory-submissions/SKILL.md)
