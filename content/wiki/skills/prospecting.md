---
type: concept
tags: [gtm, marketing-skill, prospecting]
created: 2026-09-14
updated: 2026-09-14
status: stable
...
When the user wants to find, qualify, and build a list of prospects to reach out to — across B2B SaaS, general B2B, or local small businesses. Also use when the user mentions "prospecting," "build a...
...
- [raw/_marketingskills/skills/prospecting/SKILL.md](../../raw/_marketingskills/skills/prospecting/SKILL.md)
