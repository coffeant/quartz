---
type: concept
tags: [gtm, marketing-skill, marketing-loops]
created: 2026-09-14
updated: 2026-09-14
status: stable
...
When the user wants to set up a recurring, self-running marketing workflow — a repeatable loop an AI agent runs on a cadence (weekly, daily, on a trigger) rather than a one-off task. Also use when...
...
- [raw/_marketingskills/skills/marketing-loops/SKILL.md](../../raw/_marketingskills/skills/marketing-loops/SKILL.md)
