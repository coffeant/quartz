...
When the user wants to plan, build, or optimize SMS or MMS marketing — including welcome flows, abandoned cart texts, post-purchase, win-back, promotional sends, or transactional/auth SMS. Also use...
...
- [raw/_marketingskills/skills/sms/SKILL.md](../../raw/_marketingskills/skills/sms/SKILL.md)
